        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    ...
                    <p>
                    <div><b>Our mission declares our purpose of existence as a company and our objectives.</b></div>
                    <div><b><br></b></div>
                    <div><b>To give every customer much more than what he/she asks for in terms of quality, selection, value for money and customer service, by understanding local tastes and preferences and innovating constantly to eventually provide an unmatched experience in jewellery shopping.</b></div>
                    </p>
                    ...
                    <div class="booking-form">
                        ...
                        <form role="form" method="post" action="{{ route('appointment.booking') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <input type="telephone" name="MobileNumber" id="MobileNumber" class="form-control" placeholder="Enter Phone Number" maxlength="10">
                                </div>

                                <div class="col-lg-6 col-12">
                                    <input type="date" name="AppointmentDate" id="AppointmentDate" value="" class="form-control">
                                </div>

                                <div class="col-lg-6 col-12">
                                    <input type="time" name="AppointmentTime" id="AppointmentTime" value="" class="form-control">
                                </div>
                                ...
                                <div class="col-lg-6 col-12">
                                    ...
                                    <div class="col-12 mt-3">
                                        <strong>Harga Konsultasi:</strong> <span id="feeText">Rp. 0</span>
                                    </div>
                                </div>
        ...
        $("#Specialization").on("change", function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    // Tampilkan harga dari spesialisasi
                $('#feeText').text("Rp. " + new Intl.NumberFormat('id-ID', {
                ...
                error: function (xhr) {
                    console.log("Gagal load dokter", xhr.responseText);
                }
            });
        });
    });
